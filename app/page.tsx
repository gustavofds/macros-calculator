...
export default function Home() {
  return (
      <div className="flex min-h-screen flex-col items-center justify-between p-24">
        ...
        <h2 className="text-base font-semibold leading-7 text-gray-900">Calculadora de Macros - Dieta Flexível</h2>
        <p className="mt-1 text-sm leading-6 text-gray-600">Saiba seu Gasto Calórico Diário para um Emagrecimento sustentável e duradouro.</p>
      <MacrosCalcForm />
    </div>
